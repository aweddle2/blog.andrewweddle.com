...
1. Just how do you use these coding tools to write code, like what are the actual practicalities of getting Claude or Loveable or any of these other tools to write code for me based on a prompt.
2. How much is it going to cost?
3. Has to be practical.  I'm really bad at writing code for the sake of writing code.
4. Be a decent topic to restart this Blog and hopefully get a few posts from it.  More on that soon.
